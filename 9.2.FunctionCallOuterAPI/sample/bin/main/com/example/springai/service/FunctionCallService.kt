...
/**
 * 외부 API 연동을 위한 Function Calling 서비스
 * 
...
class FunctionCallService(
     ...
     */
    fun callWithWeatherFunction(userMessage: String): String {
    ...
    /**
     * 주문 상태 조회 함수를 사용하여 호출
     */
    fun callWithOrderFunction(userMessage: String): String {
        val prompt = Prompt(UserMessage(userMessage))
        val response = chatModel.call(prompt)
        return response.results.firstOrNull()?.output?.text ?: "응답을 생성할 수 없습니다."
    }
